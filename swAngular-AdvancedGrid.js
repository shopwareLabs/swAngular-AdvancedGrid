    ...
    .directive('swAngularAdvancedGrid', function () {
        return {
            ...
            template: [
                ...
                '            <thead>',
                '                <tr>',
                '                    <th data-ng-repeat="field in options.fields" width="{{field.weight}}%">',
                ...
                '                    </li>',
                '                    <li data-ng-repeat="page in pages" class="pagination-col" data-ng-class="{\'alert-success\': currentPage.label == page.label}">',
                ...
                '                    <input type="number" class="form-control" data-ng-model="itemPerPageNumber" />',
